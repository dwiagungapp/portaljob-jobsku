...
const DetailJob = () => {
    ...
    useEffect(() => {
      ...
      if (data === null){
        return <div className="justify-center flex flex-wrap mx-10 mb-10 py-8 gap-7"><div className="w-16 h-16 border-4 border-dashed rounded-full animate-spin border-amber-300"></div></div>
      }
  ...
  <img alt="Company Foto" src={data?.company_image_url} className="rounded-full h-10 w-10 " />
    ...
    <br/><button type="button" className="justify-end py-2 px-4 bg-amber-300 hover:bg-amber-400 rounded-lg font-bold text-white ">
    Lamar sekarang
</button>
  </div>
